...
/**
 *
 * MODULE: Hero Story Block 004
 *
 */
?>

<main id="hero-story-block-mfw-004" class="d-flex align-items-start">
	<style type="text/css">
		#hero-story-block-mfw-004 {
			background: url("/wp-content/uploads/2018/02/home_garden2_portfoliodetails4.jpg") no-repeat center center fixed;
					...
					<div class="card">
						...
						<div class="card-block">
							...
							<article class="card-content pl-4 pt-5">
								<h3 class="card-text text-white">La Casa of Mason Creek</h3>
